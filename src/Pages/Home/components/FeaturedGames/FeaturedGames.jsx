...
const FeaturedGames = () => {
  ...
  return (
    <section className={`py-10 ${theme === "dark" ? "bg-black1 text-white1" : "bg-white1 text-black1"}`}>
      <div className="w-11/12 mx-auto">
        <h1 className={`text-3xl text-center mb-6 lg:text-5xl capitalize font-semibold ${theme === "dark" ? "text-white1" : "text-black1"}`}>
          Trending Games
        </h1>
