...
const Subcribtion = () => {
  ...
  const submitHanlder = (event) => {
    ...
    if (window.Email) {
      window.Email.send(emailConfig).then(() =>
        toast.success("email sent seuccesfully")
      );
    }
  };
  ...
  return (
    <div className=" flex justify-center w-full">
      <div className="lg:flex  bg-transparent justify-center items-center ">
        <div className="lg:flex sm:block items-center justify-around  rounded-t-full bg-black lg:w-[850px] w-[380px] pt-3 pb-4 lg:px-10">
          ...
          <div className="flex justify-center items-center lg:mx-4 ">
            <form
              className=" doangel flex justify-center items-center  text-black  font-bold bg-yellow-500 file-input-bordered"
