  ...
  return (
    ...
    >
      {iscreateMeetingClicked ? (
        <div className="border border-solid border-red-400 rounded-xl px-4 py-3  flex items-center justify-center">
      ...
      {(iscreateMeetingClicked || isJoinMeetingClicked) && (
        <>
          ...
          <button
            ...
            className={`w-full ${
              participantName.length < 3 ? "bg-gray-500" : "bg-purple-350"
        ...
        <div className="w-full md:mt-0 mt-4 flex flex-col">
          ...
          <div className="flex flex-col md:flex-row lg:flex-col xl:flex-row justify-between w-full mb-4">
            {selectType.map((item, index) => (
              ...
              >
                ...
                >
                  <span className="w-4 h-4 inline-block mr-2 rounded-full border border-grey bg-white"></span>
                  {item.label}
                </label>
              </div>
            ))}
          ...
          <div className="flex items-center justify-center flex-col w-full mt-2">
            {meetingType === meetingTypes.ILS ? (
              <>
                <button
                  className="w-full bg-red-400 text-white px-2 py-3 rounded-xl"
                  onClick={async (e) => {
                ...
                <button
                  className="w-full bg-red-400 text-white px-2 py-3 mt-5 rounded-xl"
                  onClick={async (e) => {
