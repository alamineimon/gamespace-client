...
const HtmlGames = () => {
  ...
  return (
    <section className="relative">
      <div className="image">
        <img
          src="https://img.freepik.com/premium-photo/white-haired-female-warrior-knight-stands-with-drawn-sword-dragon-against-backdrop-snow-capped-mountains-fantasy-artwork-scene-cgi-animation-3d-rendering_557878-1553.jpg?size=626&ext=jpg&ga=GA1.1.207808977.1658386615&semt=sph"
          alt=""
