      ...
      <div className={"navbar w-11/12 mx-auto px-0"}>
        <div className="navbar-start">
          <div className="dropdown ">
            ...
            <HiMenuAlt1 className={`text-xl hover:text-primary hover:border border-primary ${theme === "dark" ? "text-white1" : "text-black1"}`} />
            </label>
            <ul
              tabIndex={0}
              className={`menu menu-compact dropdown-content mt-6  shadow ${theme === "dark" ? "text-white1 bg-black1" : "bg-white1 text-black1"} w-52  font-bold uppercase text-sm border border-primary rounded-none`}
            >
              {navlinks}
            </ul>
          </div>
